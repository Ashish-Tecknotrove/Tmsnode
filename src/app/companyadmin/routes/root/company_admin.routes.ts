...
Router.post(
    ...
    formData.any(),
    auth.verify_companyAdmin_AuthenticateToken,
    traineeValidator.get_trainee_assigned_to_trainer_and_not_assigned(),
    auth.handleValidatorError,
    traineeController.get_trainee_assigned_to_trainer_and_not_assigned
);
...
Router.post('/getActiveTrainers',
    formData.none(),
    auth.verify_companyAdmin_AuthenticateToken,
    trainerValidator.getTrainersByCompany(),
    auth.handleValidatorError,
    trainerController.getActiveTrainers
);
