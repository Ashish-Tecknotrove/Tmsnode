...
Router.post('/block_unblock_trainer', formData.none(), auth_1.default.verifyAuthenticateToken, trainer_validator_1.default.block_unblock_trainer(), auth_1.default.handleValidatorError, trainer_controller_1.default.blockTrainer);
