            ...
            try {
                if (req.body.trainees_id.length > 0) {
                    ...
                    for (let i = 0; i < traineeData.length; i++) {
                        ...
                        yield trainer_model_1.default.findOne({ where: { id: trainer_id } }).then((data) => __awaiter(this, void 0, void 0, function* () {
                            let updateData = {
                            ...
                            }).then((updateResult) => __awaiter(this, void 0, void 0, function* () {
                                if (trainer_id != 0) {
                                    let insertData = {
