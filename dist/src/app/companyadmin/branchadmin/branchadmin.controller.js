...
class BranchAdminController {
    ...
    get_assigned_department(req, res) {
            ...
            try {
                ...
                yield company_department_model_1.default.findAll({
                    ...
                    if (data.length != 0) {
                        ...
                        res.status(response_codes_1.default.SUCCESS).json({
                            response_code: 0,
                            message: "No data were found, Department have not been assigned to this branch",
                            data: data,
                        });
                    }
                })
    ...
    get_assigned_trainer_with_department(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    assign_trainer_to_department(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield trainer_model_1.default.update(Object.assign({}, updateData), { where: where })
                    .then((trainerupdateDone) => __awaiter(this, void 0, void 0, function* () {
                    //TODO CHANGE
                    if (changeTraineeDepartment == 1) {
                        ...
                        yield trainee_model_1.default.update(Object.assign({}, updateTraineeData), { where: where })
                            .then((success) => {
                            res
            ...
            try {
                ...
                for (let i = 0; i < updateJSON.length; i++) {
                    ...
                    if (updateJSON[i]["trainer_id"] == 0) {
                        ...
                        }).then((getTrainer) => __awaiter(this, void 0, void 0, function* () {
    ...
    get_branch_assign_trainee(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield trainee_model_1.default.findAll({
                    attributes: [
