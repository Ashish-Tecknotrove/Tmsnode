...
SuperAdminRoutes.post('/getTraineeMasterFormByCompany', formData.none(), authentication, company_validator_1.default.getTraineeMasterFormByCompany(), auth_1.default.handleValidatorError, company_controller_1.default.getTraineeMasterFormByCompany);
SuperAdminRoutes.post('/updateTraineeMasterFormByCompany', formData.none(), authentication, company_validator_1.default.updateTraineeMasterFormByCompany(), auth_1.default.handleValidatorError, company_controller_1.default.updateTraineeMasterFormByCompany);
