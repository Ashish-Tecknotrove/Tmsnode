...
const controller_label_value_controller_1 = require("../../controller/languages/controller.label.value.controller");
const languages_controller_1 = require("../../controller/languages/languages.controller");
const auth_1 = require("../../middleware/auth");
const languagevalidator_1 = require("../../validator/languages/languagevalidator");
...
LanguageRoutes.get('/getValues', controller_label_value_controller_1.default.findAll);
//* App Labels Module 
// Last Work #(Vipul) 
