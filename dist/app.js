...
const reports_routes_1 = __importDefault(require("./src/app/companyadmin/routes/root/reports.routes"));
const trainer_routes_1 = __importDefault(require("./src/app/trainer/routes/root/trainer.routes"));
const reports_routes_2 = __importDefault(require("./src/app/trainer/routes/root/reports.routes"));
...
const trainee_dashboard_routes_1 = __importDefault(require("./src/app/trainee/routes/root/trainee.dashboard.routes"));
const additionalresources_routes_1 = __importDefault(require("./src/resources/additionalresources.routes"));
const clinical_routes_1 = __importDefault(require("./src/app/trainee/routes/driving/clinical/clinical.routes"));
const branchadmin_routes_1 = __importDefault(require("./src/app/companyadmin/branchadmin/branchadmin.routes"));
const departmentadmin_routes_1 = __importDefault(require("./src/app/companyadmin/departmentadmin/departmentadmin.routes"));
...
app.use("/TMS/trainee/clinical/", clinical_routes_1.default);
app.use("/TMS/trainee/dashboard/", trainee_dashboard_routes_1.default);
//TODO TRAINEE ROUTES --END
//TODO COMPANY ADMIN ROUTES
app.use("/TMS/companyadmin", company_admin_routes_1.default);
app.use("/TMS/companyadmin/reports", reports_routes_1.default);
//TODO COMPANY ADMIN ROUTES --END
//TODO TRAINER ROUTES
app.use("/TMS/trainer", trainer_routes_1.default);
app.use("/TMS/trainer/reports", reports_routes_2.default);
//TODO TRAINER ROUTES --END
//TODO Branch Admin Routes
app.use("/TMS/companyadmin/branchadmin", branchadmin_routes_1.default);
app.use("/TMS/companyadmin/departmentadmin", departmentadmin_routes_1.default);
